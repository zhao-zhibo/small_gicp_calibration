...
void CalibrateLiDAR(const std::vector<Eigen::Vector4f>& target_points, const std::vector<Eigen::Vector4f>& source_points) {
  ...
  T_roadLidar_Vehiclelidar << -0.614371,   0.78057, -0.115144,   0.5,
                             -0.771121, -0.624913,  -0.12188,    0.5,
                              -0.167091, 0.0139099,  0.985844,    0.5,
                              0,         0,         0,         1;
...
int main(int argc, char** argv) {
  ...
  pcl::io::loadPCDFile("/home/zhao/Codes/ICP/small_gicp_calibration/data/Vehicle_RoadsidePCD/vehicle_377654.814799999.pcd", *vehicleLiDARPoints); // 点云的pcd路径
  
  // 2. target 路侧点云
  pcl::PointCloud<pcl::PointXYZ>::Ptr roadLiDARPoints(new pcl::PointCloud<pcl::PointXYZ>());
  pcl::io::loadPCDFile("/home/zhao/Codes/ICP/small_gicp_calibration/data/Vehicle_RoadsidePCD/road_377654.846982955.pcd", *roadLiDARPoints); // 高精地图的pcd路径
