...
void CalibrateLiDAR(const std::vector<Eigen::Vector4f>& target_points, const std::vector<Eigen::Vector4f>& source_points) {
  ...
  T_roadLidar_Vehiclelidar <<
      0.283677,  -0.198554,   0.938138,  -5.13306,
     -0.605939,  -0.795372,   0.0148872, -6.89658,
      0.743212,  -0.572678,  -0.34594,    0.985577,
      0.0,        0.0,        0.0,        1.0;
...
int main(int argc, char** argv) {
  ...
  pcl::io::loadPCDFile("/home/zhao/Data/HK_data/Temp_large_compare/1751960037.7146_roadSide.pcd", *roadLiDARPoint);

  // 2. source：车载点云
  pcl::PointCloud<pcl::PointXYZ>::Ptr vehileLiDARPoint(new pcl::PointCloud<pcl::PointXYZ>());
  pcl::io::loadPCDFile("/home/zhao/Data/HK_data/Temp_large_compare/1751960037.7312_VehicleleCloud.pcd", *vehileLiDARPoint);
