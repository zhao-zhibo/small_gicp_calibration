...
void CalibrateLiDAR(const std::vector<Eigen::Vector4f>& target_points, const std::vector<Eigen::Vector4f>& source_points) {
  ...
  target = voxelgrid_sampling_omp(*target, downsampling_resolution * 3, num_threads);
...
int main(int argc, char** argv) {
  ...
  pcl::io::loadPCDFile("/media/zhao/ZhaoZhibo1/AllData/2024_1030_suidao/zhang_0m/1730278105.310431004.pcd", *LiDARPoints); // 替换为实际路径
  ...
  pcl::io::loadPCDFile("/media/zhao/ZhaoZhibo1/AllData/2024_1030_suidao/VehicleDataAndResult/Map/pcd/MergedMap_duan.pcd", *MapPoints); // 替换为实际路径
