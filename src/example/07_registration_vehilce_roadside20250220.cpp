...
int main(int argc, char** argv) {
  ...
  pcl::io::loadPCDFile("/home/zhao/Codes/ICP/small_gicp_calibration/data/Vehicle_RoadsidePCD/vehicle_377662.132199999.pcd", *vehicleLiDARPoints); // 点云的pcd路径
  
  // 2. target 路侧点云
  pcl::PointCloud<pcl::PointXYZ>::Ptr roadLiDARPoints(new pcl::PointCloud<pcl::PointXYZ>());
  pcl::io::loadPCDFile("/home/zhao/Codes/ICP/small_gicp_calibration/data/Vehicle_RoadsidePCD/road_377662.160892009.pcd", *roadLiDARPoints); // 高精地图的pcd路径
